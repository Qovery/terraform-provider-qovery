...
Use this data source to retrieve information about an existing Qovery terraform service.
...
- `variables` (Attributes Set) Terraform input variables. (see [below for nested schema](#nestedatt--variables))
