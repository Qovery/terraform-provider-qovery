...
- `nat_gateways` (Attributes) GCP NAT Gateway static IP configuration. (see [below for nested schema](#nestedatt--features--nat_gateways))
- `static_ip` (Boolean) Whether static IPs are enabled. Immutable after creation.
