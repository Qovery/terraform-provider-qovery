...
Provides a Qovery helm data source. This can be used to read existing Qovery Helm chart deployments.
...
- `arguments` (List of String) Helm CLI arguments.
...
- `set` (Map of String) Helm set override values.
- `set_json` (Map of String) Helm set_json override values.
- `set_string` (Map of String) Helm set_string override values.
