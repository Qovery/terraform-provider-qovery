...
Use this data source to retrieve information about an existing Qovery database.
...
- `password` (String, Sensitive) The password to connect to your database. This is a sensitive value and will not be displayed in plan output.
