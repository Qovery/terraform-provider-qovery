...
- `password` (String) Required if kinds are `DOCKER_HUB`, `GITHUB_CR`, `GITLAB_CR`, `GENERIC_CR`.
...
- `username` (String) Required if kinds are `DOCKER_HUB`, `GITHUB_CR`, `GITLAB_CR`, `GENERIC_CR`.
## Import
```shell
