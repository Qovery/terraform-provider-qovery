		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.qovery_container.test", "advanced_settings_json", "{\"deployment.lifecycle.pre_stop_exec_command\":[],\"network.ingress.proxy_body_size_mb\":101}"),
					resource.TestCheckResourceAttr("data.qovery_container.test", "auto_deploy", "true"),
				),
			},
		},
	})
