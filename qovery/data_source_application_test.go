		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.qovery_application.test", "custom_domains.0.validation_domain", "zc4425337-z598be6b7-gtw.zc531a994.rustrocks.cloud"),
					resource.TestCheckResourceAttr("data.qovery_application.test", "custom_domains.0.status", "VALIDATION_PENDING"),
					resource.TestCheckResourceAttr("data.qovery_application.test", "external_host", "zc4425337-z598be6b7-gtw.zc531a994.rustrocks.cloud"),
					resource.TestCheckResourceAttr("data.qovery_application.test", "internal_host", "app-z1defeb1b"),
