...
var flickerAllowlist = map[string]string{
	...
	"qovery_application.external_secrets.id":                         "set-element id populated after apply; cosmetic flicker only",
	...
	"qovery_container.external_secrets.id":                           "set-element id populated after apply; cosmetic flicker only",
	...
	"qovery_helm.external_secrets.id":                                "set-element id populated after apply; cosmetic flicker only",
	...
	"qovery_job.external_secrets.id":                                 "set-element id populated after apply; cosmetic flicker only",
	...
	"qovery_terraform_service.external_secrets.id":                           "set-element id populated after apply; cosmetic flicker only",
