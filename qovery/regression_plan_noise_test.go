...
var flickerAllowlist = map[string]string{
	...
	"qovery_application.external_secrets.id":                        "TODO: add UseStateForUnknown (set-element id; cosmetic flicker only)",
	"qovery_application.external_secret_files.id":                   "TODO: add UseStateForUnknown (set-element id; cosmetic flicker only)",
	...
	"qovery_environment.external_secrets.id":                        "TODO: add UseStateForUnknown (set-element id; cosmetic flicker only)",
	"qovery_environment.external_secret_files.id":                   "TODO: add UseStateForUnknown (set-element id; cosmetic flicker only)",
	...
	"qovery_job.external_secrets.id":                                "TODO: add UseStateForUnknown (set-element id; cosmetic flicker only)",
	"qovery_job.external_secret_files.id":                           "TODO: add UseStateForUnknown (set-element id; cosmetic flicker only)",
