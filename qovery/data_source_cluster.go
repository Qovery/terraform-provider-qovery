							...
							"qovery_node_pools": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"gpu_override": schema.SingleNestedAttribute{
										Description:         "The Qovery GPU node pool. Its presence means the GPU node pool exists.",
										MarkdownDescription: "The GPU node pool, which runs the workloads that request GPUs. Its presence means the GPU node pool exists.",
										Optional:            true,
										Computed:            false,
										Attributes: map[string]schema.Attribute{
											"requirements": schema.ListNestedAttribute{
												Description:         "List of requirements for the GPU node pool",
												MarkdownDescription: "Node selection requirements for the GPU node pool.",
												Required:            true,
												Computed:            false,
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
											...
											"disk_size_in_gib": schema.Int64Attribute{
												...
												MarkdownDescription: "Root disk size in GiB for the GPU nodes.",
												Computed:            true,
											},
											"disk_iops": schema.Int64Attribute{
												Description:         "Disk IOPS for the GPU nodes.",
												MarkdownDescription: "Provisioned IOPS of the root disk of the GPU nodes, when set.",
												Computed:            true,
											},
											"disk_throughput": schema.Int64Attribute{
												Description:         "Disk throughput in MB/s for the GPU nodes.",
												MarkdownDescription: "Provisioned throughput in MB/s of the root disk of the GPU nodes, when set.",
												Computed:            true,
											},
											"spot_enabled": schema.BoolAttribute{
												Description:         "Whether the GPU node pool runs on spot instances",
												MarkdownDescription: "Whether the GPU node pool runs on EC2 Spot instances.",
												Computed:            true,
											},
											"consolidation": schema.SingleNestedAttribute{
												Description:         "Specifies the period to consolidate nodes (by default, no consolidation happens)",
												MarkdownDescription: "Node consolidation schedule for the GPU node pool.",
												Optional:            true,
												Computed:            false,
												Attributes: map[string]schema.Attribute{
													"enabled": schema.BoolAttribute{
											...
											"limits": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "Resource limits for the GPU node pool.",
												Optional:            true,
												Attributes: map[string]schema.Attribute{
													"enabled": schema.BoolAttribute{
														Description:         "Enabled the limit",
													...
													"max_cpu_in_vcpu": schema.Int64Attribute{
														Description:         "The maximum number of cpu cores to be used inside the GPU node pool",
														MarkdownDescription: "Maximum total vCPU cores for the GPU node pool.",
														Required:            true,
														Computed:            false,
													},
													"max_memory_in_gibibytes": schema.Int64Attribute{
														Description:         "The maximum number of memory to be used inside the GPU node pool",
														MarkdownDescription: "Maximum total memory in GiB for the GPU node pool.",
														Required:            true,
														Computed:            false,
													},
													"max_gpu": schema.Int64Attribute{
														Description:         "The maximum number of GPUs to be used inside the GPU node pool",
														MarkdownDescription: "Maximum total number of GPUs for the GPU node pool.",
														Computed:            true,
													},
												},
											},
