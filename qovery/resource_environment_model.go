...
func convertDomainEnvironmentToEnvironment(ctx context.Context, state Environment, env *environment.Environment) Environment {
	return Environment{
		...
		BuiltInEnvironmentVariables:  convertDomainVariablesToEnvironmentVariableListWithNullableInitialState(ctx, state.BuiltInEnvironmentVariables, env.BuiltInEnvironmentVariables, variable.ScopeBuiltIn, "BUILT_IN").toTerraformSet(ctx),
