...
func convertDomainEnvironmentToEnvironment(ctx context.Context, state Environment, env *environment.Environment) Environment {
	return Environment{
		...
		ExternalSecrets:              convertDomainExternalSecretsToExternalSecretList(env.ExternalSecrets, state.ExternalSecrets).toTerraformSet(ctx),
		ExternalSecretFiles:          convertDomainExternalSecretFilesToExternalSecretFileList(env.ExternalSecretFiles, state.ExternalSecretFiles).toTerraformSet(ctx),
	}
}
