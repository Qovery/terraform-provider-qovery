...
func convertDomainContainerToContainer(ctx context.Context, state Container, container *container.Container) Container {
	...
	return Container{
		...
		BuiltInEnvironmentVariables:  convertDomainVariablesToEnvironmentVariableList(ctx, container.BuiltInEnvironmentVariables, variable.ScopeBuiltIn, "BUILT_IN").toTerraformSet(ctx),
