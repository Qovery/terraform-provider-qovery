		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.qovery_cluster.test", "name", "qovery-eks-tests"),
					...
					resource.TestCheckResourceAttr("data.qovery_cluster.test", "instance_type", "T3A_XLARGE"),
					resource.TestCheckResourceAttr("data.qovery_cluster.test", "min_running_nodes", "3"),
					resource.TestCheckResourceAttr("data.qovery_cluster.test", "max_running_nodes", "30"),
