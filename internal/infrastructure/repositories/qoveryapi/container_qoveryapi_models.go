...
func newDomainContainerFromQovery(c *qovery.ContainerResponse, deploymentStageID string, mapSettings map[string]interface{}) (*container.Container, error) {
	if c == nil {
