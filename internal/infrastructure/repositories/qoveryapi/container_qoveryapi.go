...
func (c containerQoveryAPI) Create(ctx context.Context, environmentID string, request container.UpsertServiceRequest) (*container.Container, error) {
	...
	if settingsErr != nil {
		return nil, apierrors.NewCreateApiError(apierrors.ApiResourceContainer, newContainer.Id, nil, settingsErr)
	}
...
func (c containerQoveryAPI) Get(ctx context.Context, containerID string) (*container.Container, error) {
	...
	if settingsErr != nil {
		return nil, apierrors.NewCreateApiError(apierrors.ApiResourceContainer, container.Id, nil, settingsErr)
	}
