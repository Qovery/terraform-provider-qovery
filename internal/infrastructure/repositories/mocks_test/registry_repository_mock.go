...
type mockConstructorTestingTNewRegistryRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewRegistryRepository(t mockConstructorTestingTNewRegistryRepository) *RegistryRepository {
