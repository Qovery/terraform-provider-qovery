...
func (_m *ProjectRepository) Create(ctx context.Context, organizationID string, request project.UpsertRepositoryRequest) (*project.Project, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, project.UpsertRepositoryRequest) (*project.Project, error)); ok {
...
func (_c *ProjectRepository_Create_Call) RunAndReturn(run func(context.Context, string, project.UpsertRepositoryRequest) (*project.Project, error)) *ProjectRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ProjectRepository_Get_Call) RunAndReturn(run func(context.Context, string) (*project.Project, error)) *ProjectRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ProjectRepository_Update_Call) RunAndReturn(run func(context.Context, string, project.UpsertRepositoryRequest) (*project.Project, error)) *ProjectRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
