...
type mockConstructorTestingTNewContainerRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewContainerRepository(t mockConstructorTestingTNewContainerRepository) *ContainerRepository {
