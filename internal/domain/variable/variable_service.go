...
type Service interface {
	...
	Update(ctx context.Context, scopeResourceID string, environmentVariablesRequest DiffRequest, environmentVariableAliasesRequest DiffRequest, environmentVariableOverridesRequest DiffRequest) (Variables, error)
}
