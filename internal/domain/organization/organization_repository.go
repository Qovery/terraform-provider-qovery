...
//go:generate mockery --testonly --with-expecter --name=Repository --structname=OrganizationRepository --filename=organization_repository_mock.go --output=../../infrastructure/repositories/mocks_test/ --outpkg=mocks_test
