...
const (
	...
	APIResourceOrganizationMember                 APIResource = "organization member"
	...
	APIResourceContainerExternalSecret            APIResource = "container external secret"
	APIResourceJobExternalSecret                  APIResource = "job external secret"
	APIResourceHelmExternalSecret                 APIResource = "helm external secret"
	APIResourceTerraformServiceExternalSecret     APIResource = "terraform service external secret"
	APIResourceEnvironmentExternalSecret          APIResource = "environment external secret"
	APIResourceApplicationExternalSecretFile      APIResource = "application external secret file"
	APIResourceContainerExternalSecretFile        APIResource = "container external secret file"
	APIResourceJobExternalSecretFile              APIResource = "job external secret file"
	APIResourceHelmExternalSecretFile             APIResource = "helm external secret file"
	APIResourceTerraformServiceExternalSecretFile APIResource = "terraform service external secret file"
	APIResourceEnvironmentExternalSecretFile      APIResource = "environment external secret file"
