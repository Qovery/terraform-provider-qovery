...
// NOTE: This forces the implementation of the interface organization.Service by organizationService at compile time.
var _ organization.Service = organizationService{}

// NewOrganizationService return a new instance of a organization.Service that uses the given organization.Repository.
